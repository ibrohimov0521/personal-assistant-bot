window.AssistantDemoData = {
  ...
  admin: {
    ...
    chores: {
      members: [
        { id: 1, name: "@zafar_aka" },
        { id: 2, name: "@anvar_aka" },
        { id: 3, name: "@nuriddin_aka" },
      ],
      pairs: [
        { id: 1, first_name: "@laziz_aka", second_name: "@nuriddin_aka" },
        { id: 2, first_name: "@zafar_aka", second_name: "@anvar_aka" },
      ],
      today_member: "@zafar_aka",
      tomorrow_member: "@anvar_aka",
      next_cleaning_date: "2026-05-24",
      next_cleaning_pair: ["@laziz_aka", "@nuriddin_aka"],
      following_cleaning_pair: ["@zafar_aka", "@anvar_aka"],
  ...
  prayer: {
    ...
    next: { name: "Asr", time: "17:17", day_label: "Bugun" },
    times: [
